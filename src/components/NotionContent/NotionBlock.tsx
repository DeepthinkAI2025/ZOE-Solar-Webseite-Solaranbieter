      ...
      case 'paragraph':
        return (
          <p className="notion-paragraph text-gray-700 leading-relaxed mb-4">
            {block.paragraph.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
      ...
      case 'heading_1':
        return (
          <h1 className="notion-h1 text-3xl font-bold text-gray-900 mb-4 mt-8">
            {block.heading_1.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
                  ${text.annotations?.bold ? 'font-bold' : ''}
      ...
      case 'heading_2':
        return (
          <h2 className="notion-h2 text-2xl font-bold text-gray-900 mb-3 mt-6">
            {block.heading_2.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
                  ${text.annotations?.bold ? 'font-bold' : ''}
      ...
      case 'heading_3':
        return (
          <h3 className="notion-h3 text-xl font-bold text-gray-900 mb-2 mt-4">
            {block.heading_3.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
                  ${text.annotations?.bold ? 'font-bold' : ''}
      ...
      case 'bulleted_list_item':
        return (
          <li className="notion-bulleted-list-item ml-4 mb-2 list-disc text-gray-700">
            {block.bulleted_list_item.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
                  ${text.annotations?.bold ? 'font-bold' : ''}
      ...
      case 'numbered_list_item':
        return (
          <li className="notion-numbered-list-item ml-4 mb-2 list-decimal text-gray-700">
            {block.numbered_list_item.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
                  ${text.annotations?.bold ? 'font-bold' : ''}
      ...
      case 'quote':
        return (
          <blockquote className="notion-quote border-l-4 border-green-500 pl-4 py-2 my-4 bg-green-50 italic text-gray-700">
            {block.quote.rich_text.map((text: RichText, index: number) => (
              <span
                key={index}
                className={`
                  ${text.annotations?.bold ? 'font-bold' : ''}
          ...
          `}>
            <div className="flex items-start">
              ...
              <div className="flex-1">
                {block.callout.rich_text.map((text: RichText, index: number) => (
                  <span
                    key={index}
        ...
        return (
          <details className="notion-toggle border border-gray-300 rounded-lg p-4 my-4">
            <summary className="font-semibold cursor-pointer hover:text-green-600">
              {block.toggle.rich_text.map((text: RichText, index: number) => (
