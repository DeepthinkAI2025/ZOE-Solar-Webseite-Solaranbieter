...
const ServiceWizard: React.FC = () => {
    ...
    const handleAnalysis = async () => {
        ...
        try {
            ...
            const prompt = `Analysiere die folgende Service-Anfrage eines Kunden und finde den am besten passenden Service aus der bereitgestellten JSON-Liste. Antworte nur mit der Service-ID des passenden Eintrags. Wenn nichts klar passt, nutze 'plan-sonstiges'.
            ...
            const schema = {
                ...
                properties: {
                    serviceId: {
                        type: Type.STRING,
                        description: "Die ID des am besten passenden Service-Eintrags."
                    }
                },
                required: ["serviceId"]
            };
