...
const Solutions: React.FC = () => {
  return (
    <section id="system" className="relative py-24 bg-white text-gray-900 overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="relative max-w-8xl mx-auto px-6">
        <div className="text-center mb-16 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 border border-green-200 mb-6">
            ...
            <span className="text-sm font-semibold text-green-600 uppercase tracking-wider">Unser System</span>
          </div>

          <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mt-2 mb-6">
            Das ZOE Solar Prinzip:
            <span className="block text-green-600">Partnerschaft für Generationen</span>
          </h2>
