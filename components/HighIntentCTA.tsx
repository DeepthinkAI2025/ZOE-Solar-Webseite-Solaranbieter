...
const HighIntentCTA: React.FC<HighIntentCTAProps> = ({ setPage, customerType }) => {
  ...
  return (
    <section className="relative py-24 bg-gradient-to-b from-white via-slate-50 to-slate-100 text-slate-900 overflow-hidden" aria-labelledby="cta-heading">
      {/* Background Effects - Subtle like other sections */}
      <div className="absolute inset-0">
        <div className="absolute -top-24 -right-32 h-96 w-96 rounded-full bg-primary-500/10 blur-[160px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-50 border border-primary-200">
            ...
            <span className="text-sm font-semibold text-primary-600 uppercase tracking-wider">
              {customerType === 'private' ? 'Premium-Service f-r Privatkunden' : 'Exklusiv f-r Unternehmen'}
            </span>
            <div className="flex items-center gap-1">
              <span className="text-xs bg-primary-50 text-primary-700 px-2 py-0.5 rounded-full font-medium">KOSTENLOS</span>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h2
            id="cta-heading"
            className="text-5xl md:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-primary-700 to-slate-900 leading-tight mb-8"
          >
            {customerType === 'private' ? 'Ihr Dach wird zur Goldmine' : 'Ihr Standort wird profitabel'}
          </h2>

          <div className="max-w-4xl mx-auto mb-8">
            <p className="text-xl md:text-2xl text-slate-700 leading-relaxed font-medium">
              {customerType === 'private'
                ? 'Entdecken Sie, wie Ihr Dach j-hrlich tausende Euro spart und gleichzeitig die Umwelt sch-tzt.'
          ...
          {currentBulletPoints.map((point, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-primary-700 transition-colors duration-300">
                  {point.title}
                </h3>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button
            ...
            className="bg-primary-600 hover:bg-primary-700 text-white font-bold py-4 px-8 rounded-xl text-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          >
          ...
          <button
            onClick={handleChat}
            className="bg-white border-2 border-primary-600 hover:bg-primary-50 text-primary-700 hover:text-primary-800 font-bold py-4 px-8 rounded-xl text-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          >
            <div className="flex items-center gap-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-sm border border-white/50 rounded-full px-6 py-3 shadow-lg">
            <div className="flex -space-x-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-primary-400 to-emerald-400 flex items-center justify-center text-white text-xs font-bold">
                -'
              </div>
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 flex items-center justify-center text-white text-xs font-bold">
                -'
              </div>
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-400 to-purple-500 flex items-center justify-center text-white text-xs font-bold">
                -'
              </div>
            </div>
            <span className="text-sm font-semibold text-slate-700">-ber 500 zufriedene Kunden vertrauen uns</span>
          </div>
        </div>
      </div>
    </section>
