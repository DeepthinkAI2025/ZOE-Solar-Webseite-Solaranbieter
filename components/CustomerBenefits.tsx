...
const WhyZoeSolar: React.FC<CustomerBenefitsProps> = ({ customerType }) => {
  ...
  return (
    <section className="relative py-24 bg-white text-gray-900 overflow-hidden" aria-labelledby="why-zoe-heading">
      {/* Background Effects */}
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 border border-green-200 mb-6">
            ...
            <span className="text-sm font-semibold text-green-600 uppercase tracking-wider">Warum ZOE Solar</span>
          </div>

          <h2 id="why-zoe-heading" className="text-4xl md:text-6xl font-bold leading-tight mb-6 text-gray-900">
            Ihr vertrauensvoller Partner
            <span className="block text-green-600">für die Energiewende</span>
          </h2>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-green-600">{strength.stat}</div>
                    <div className="text-xs text-gray-500">{strength.detail}</div>
                  </div>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">{strength.title}</h3>
        ...
        <div className="grid gap-12 lg:grid-cols-2 mb-20">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-gray-900 mb-8">Was unsere Kunden sagen</h3>
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-200 backdrop-blur-sm">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-green-600 font-medium">{testimonials[activeTestimonial].type}</div>
          ...
          {/* News */}
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-gray-900 mb-8">Aktuelle Entwicklungen</h3>
            <div className="space-y-4">
              {newsItems.map((news, index) => (
                <div
                  key={news.title}
                  className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 backdrop-blur-sm"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
        ...
        {/* Call to Action */}
        <div className="text-center bg-white border border-gray-200 rounded-3xl p-12 shadow-lg">
          <h3 className="text-4xl font-bold mb-6 text-gray-900">Bereit für Ihre Energiewende?</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-green-600 text-white font-bold py-4 px-8 rounded-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Kostenlose Analyse starten
            </button>
            <button className="border-2 border-green-600 text-green-600 font-bold py-4 px-8 rounded-lg hover:bg-green-50 transition-all duration-300">
