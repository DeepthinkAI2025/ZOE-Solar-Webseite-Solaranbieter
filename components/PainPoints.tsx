                    ...
                    <div>
                        <div className="text-center max-w-4xl mx-auto relative z-50 mb-8 md:mb-12">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-50 border border-primary-200 mb-6">
                                ...
                                <span className="text-sm font-semibold text-primary-600 uppercase tracking-wider">Der ZOE Solar Vorteil</span>
                            </div>

                            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mt-2 mb-6">
                                Sicherheit für Ihre
                                <span className="block text-primary-600">Familie</span>
                            </h2>
                                    ...
                                    >
                                        <div className="relative w-full bg-white rounded-3xl p-8 md:p-12 flex items-center border border-slate-200 shadow-2xl">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 w-full relative z-10">
                                                ...
                                                {/* Solution Column */}
                                                <div className="space-y-3 border-t-2 md:border-t-0 md:border-l-2 border-primary-300 pt-8 md:pt-0 md:pl-8">
                                                    <div className="flex items-center gap-4">
                                                        <div className="bg-primary-50 p-3 rounded-xl border border-primary-200">
                                                            <Icon name={item.solution.icon} className="w-12 h-12 text-primary-500 flex-shrink-0" />
                                                        </div>
                                                        <div>
                                                            <h4 className="text-sm font-bold text-primary-600 uppercase tracking-wider">Der ZOE Solar Standard</h4>
                                                    ...
                                                    {item.solution.guarantee && (
                                                        <div className="mt-6 pt-6 border-t border-dashed border-slate-300">
                                                             <div className="flex items-center gap-3">
                                                                ...
                                                                <h5 className="font-bold text-primary-800">{item.solution.guarantee.title}</h5>
                                                             </div>
                                                             <p className="text-primary-900/90 font-semibold italic mt-2 pl-9">
