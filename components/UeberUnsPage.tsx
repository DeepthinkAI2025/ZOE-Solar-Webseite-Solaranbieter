...
const teamMembers = [
    { name: 'Solar-Experten Team', role: 'Zertifizierte Fachkräfte', imageUrl: 'https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2070&auto=format&fit=crop' },
    { name: 'Technik & Ingenieurwesen', role: 'Projektplanung & Qualitätssicherung', imageUrl: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070&auto=format&fit=crop' },
    { name: 'Kundenservice & Beratung', role: 'Persönliche Betreuung', imageUrl: 'https://images.unsplash.com/photo-1581093458791-9d3a6ea6b8ac?q=80&w=2070&auto=format&fit=crop' },
];
