...
const CategoryIcon: React.FC<{ name: string; isActive: boolean }> = ({ name, isActive }) => {
    ...
    const icons: { [key: string]: React.ReactNode } = {
        ...
        'Wärmepumpen': <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth}><path strokeLinecap="round" strokeLinejoin="round" d="M12 3a7.5 7.5 0 00-7.477 7.032 4.5 4.5 0 10.023 8.968H12a7.5 7.5 0 100-15z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l1.5 1.5L12 12l1.5 1.5L15 12" /></svg>,
        'Smart-Meter/EMS': <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth}><path strokeLinecap="round" strokeLinejoin="round" d="M9 2.25h6a2.25 2.25 0 012.25 2.25v15a2.25 2.25 0 01-2.25 2.25H9A2.25 2.25 0 016.75 19.5v-15A2.25 2.25 0 019 2.25z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 6h4.5M9.75 9.75h4.5M12 13.5v2.25M9.75 18h4.5" /></svg>
    };
