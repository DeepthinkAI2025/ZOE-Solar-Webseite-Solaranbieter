...
const smartEnergyData = {
  private: {
    ...
    keyMetrics: [
      { label: 'CO₂-Einsparung', value: '4,2', hint: 'Tonnen pro Jahr', color: 'text-emerald-400' },
      { label: 'Erneuerbare Energie', value: '100%', hint: 'Sauberer Solarstrom', color: 'text-green-400' },
  ...
  business: {
    ...
    keyMetrics: [
      { label: 'CO₂-Neutral', value: '100%', hint: 'Bei voller Autarkie', color: 'text-emerald-400' },
      { label: 'Green Image', value: '+40%', hint: 'Verbesserte Reputation', color: 'text-green-400' },
  ...
  return (
    <div
      ...
      className={`relative p-6 rounded-2xl border-2 transition-all duration-300 cursor-pointer group hover:scale-105 ${
        isSelected
          ? 'border-green-300 bg-gradient-to-br from-green-50 to-emerald-50 shadow-xl shadow-green-100/50'
          : 'border-gray-200 bg-white hover:border-gray-300 hover:shadow-lg'
      }`}
    >
      {feature.popular && (
        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
          <span className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md">
            PREMIUM
          </span>
        </div>
      )}
      ...
      <ul className="space-y-2">
        {feature.benefits.map((benefit, index) => (
          <li key={index} className="flex items-start gap-2 text-sm">
            ...
            <span className={isSelected ? 'text-green-700' : 'text-gray-700'}>
              {benefit}
            </span>
          </li>
        ))}
  ...
  return (
    <section className="relative py-20 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute -top-40 -right-40 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-green-200/10 to-emerald-200/5 blur-[200px]" />
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200/50">
                  ...
                  <div>
                    <h4 className="font-semibold text-green-800">CO₂-Reduzierung</h4>
                    <p className="text-sm text-green-700">Aktiver Beitrag zum Klimaschutz</p>
                  </div>
                </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200/60 shadow-inner">
                ...
                <div className="space-y-4 text-left">
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm font-bold text-green-600">4,2t/Jahr</span>
                    </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-lg font-bold text-green-600">Hoch</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                ...
                <button
                  ...
                  className="mt-8 w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold py-4 px-8 rounded-2xl hover:from-green-700 hover:to-emerald-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
                >
                  {currentData.cta}
                </button>
              </div>
