      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-slate-600 mt-4">
            Sehen Sie selbst, wie ZOE Solar die Energiewende für Unternehmen vorantreibt. Klicken Sie, um ein einzigartiges Video mit einer AI-Video-API (OpenRouter / Mistral) zu generieren, das unsere Werte und Vorteile zeigt.
          </p>
        </div>
