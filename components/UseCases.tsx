...
const SolutionCard: React.FC<{
    ...
    return (
        <div
            ...
            className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-100/50 transition-all duration-500 hover:-translate-y-2 border border-gray-100/50 overflow-hidden cursor-pointer h-full transform-gpu"
            style={{
        ...
        >
            ...
            <div className={`absolute inset-0 bg-gradient-to-br transition-all duration-500 z-10 ${
                isHovered
                    ? 'from-green-50/30 via-transparent to-blue-50/20'
                    : 'from-green-50/0 via-transparent to-blue-50/0'
            }`} />
            ...
            <div className="p-6 relative z-20">
                ...
                <div className="flex items-center justify-between">
                    <div className={`font-bold text-sm transition-all duration-300 ${
                        isHovered ? 'text-green-700 scale-105' : 'text-green-600'
                    }`}>
                        {solution.savings}
                    </div>
                    <div className={`transition-all duration-300 transform ${
                        isHovered ? 'text-green-600 translate-x-1' : 'text-gray-500'
                    }`}>
        ...
        <section id="anwendungsfaelle" className="relative py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden">
            ...
            <div className="relative w-full px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/60 mb-8 shadow-sm backdrop-blur-sm">
                        ...
                        <span className="text-base font-bold text-green-700 uppercase tracking-wider">
                            {currentData.badge}
                        </span>
                    </div>

                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-green-800 to-gray-900 leading-tight mb-8 drop-shadow-sm">
                        {currentData.title}
                    </h2>
                    ...
                    {canScroll && (
                        <>
                            <button
                                ...
                                className="absolute left-2 top-1/2 -translate-y-1/2 z-20 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-gray-200/80 hover:border-green-300 hover:shadow-green-200/50 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-300 hover:scale-110 group"
                                aria-label="Vorherige Lösungen anzeigen"
                                onMouseEnter={() => setIsAutoPlaying(false)}
                                onMouseLeave={() => setTimeout(() => setIsAutoPlaying(true), 2000)}
                            >
                                <svg className="w-6 h-6 text-gray-700 group-hover:text-green-600 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                className="absolute right-2 top-1/2 -translate-y-1/2 z-20 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-gray-200/80 hover:border-green-300 hover:shadow-green-200/50 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-300 hover:scale-110 group"
                    ...
                    {canScroll && (
                        <div className="flex justify-center mt-12 space-x-4">
                            {Array.from({ length: maxIndex + 1 }, (_, i) => (
                                ...
                                >
                                    {i === currentIndex && (
                                        <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full animate-pulse opacity-80" />
                                    )}
                                </button>
                            ))}
                        </div>
                        ...
                        <div className="flex justify-center mt-8">
                            ...
                            >
                                <div className={`w-3 h-3 rounded-full transition-all duration-300 ${
                                    isAutoPlaying ? 'bg-green-500 animate-pulse shadow-green-300 shadow-md' : 'bg-gray-400'
                                }`} />
