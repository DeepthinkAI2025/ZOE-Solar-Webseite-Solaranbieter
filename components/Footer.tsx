...
const FooterLink: React.FC<{ page: Page; setPage: (page: Page, options?: { scrollToTop?: boolean }) => void; children: React.ReactNode; isExternal?: boolean; href?: string, action?: () => void }> = ({ page, setPage, children, isExternal, href, action }) => (
    <li>
        <a 
            onClick={(e) => {
                e.preventDefault();
        ...
        <div className="grid lg:grid-cols-12 gap-12 mb-12">
            ...
            <div className="lg:col-span-3">
                ...
                <div className="flex items-center gap-5">
                    <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-primary-400 transition-colors" aria-label="LinkedIn">
