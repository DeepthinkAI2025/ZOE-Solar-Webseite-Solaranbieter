...
const serviceDescriptions: Record<ApiServiceKey, string> = {
  openrouter: 'Aktiviert KI-Empfehlungen, Content-Automation und Analysen im Dashboard.',
    ...
    return (
      <section className="bg-white border border-slate-200 rounded-3xl shadow-sm">
        <header className="px-6 py-5 border-b border-slate-100">
          ...
          <p className="text-slate-600">
            Hinterlegen oder aktualisieren Sie hier die Schlüssel für OpenRouter/Mistral, Google-Dienste, Ahrefs und das Google Business Profile.
          </p>
        </header>
