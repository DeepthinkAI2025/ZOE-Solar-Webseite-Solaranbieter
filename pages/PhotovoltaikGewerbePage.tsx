...
const PhotovoltaikGewerbePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-y">
        ...
        <article itemscope itemtype="https://schema.org/Article">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="body-lead text-gray-600 mb-6">
        ...
        <section className="mb-16" itemprop="articleBody">
          <h2 className="heading-section text-gray-900 mb-8 text-center">
        ...
        <section className="bg-green-600 text-white p-8 rounded-lg text-center" itemprop="articleBody">
          ...
          <p className="body-lead mb-8 opacity-90">
