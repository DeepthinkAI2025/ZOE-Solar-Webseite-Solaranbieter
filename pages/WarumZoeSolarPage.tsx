...
const Icon: React.FC<{ name: string }> = ({ name }) => {
    const className = 'w-16 h-16 text-primary-600 bg-primary-50 p-3 rounded-full';
...
const WarumZoeSolarHero: React.FC<{ onCtaClick: () => void }> = ({ onCtaClick }) => {
    return (
        <section className="warum-zoe-hero bg-slate-50 overflow-hidden">
            <div className="container mx-auto px-6 section-y">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    {/* Left Column: Text Content */}
                    <div className="text-center lg:text-left">
                        <h1 className="heading-hero text-slate-900 tracking-tighter animate-slide-in-up">
                            Der ZOE Solar Unterschied.
                        </h1>
                        <h2 className="heading-hero text-primary-600 tracking-tighter mt-2 animate-slide-in-up">
                            Qualität. Partnerschaft. Innovation.
                        </h2>
                        <p className="mt-6 body-lead text-slate-600 max-w-xl mx-auto lg:mx-0 animate-slide-in-up">
                           Entdecken Sie die drei Säulen, die den Erfolg Ihres Projekts garantieren und uns vom Wettbewerb abheben.
                        </p>
                        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-slide-in-up">
                            <button onClick={onCtaClick} className="w-full sm:w-auto bg-primary-600 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-primary-700 transition-all duration-300 shadow-lg cta-button-glow">
    ...
    return (
        ...
        <div className="bg-white">
                    ...
                    <div className="container mx-auto px-6 section-y">
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            <div className={`${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
                                ...
                                <h2 className="heading-section text-slate-900 mb-4">{value.title}</h2>
            ...
            <section className="bg-white">
                <div className="container mx-auto px-6 section-y">
                    <div className="bg-primary-600 rounded-2xl text-white p-12 text-center shadow-2xl max-w-4xl mx-auto">
                        <h2 className="heading-section text-white mb-4">Bereit für eine Photovoltaik-Lösung ohne Kompromisse?</h2>
                        <p className="body-lead text-primary-100 max-w-3xl mx-auto mb-8">
                         ...
                         <button onClick={openChat} className="bg-white text-primary-600 font-bold py-4 px-10 rounded-lg text-lg hover:bg-primary-50 transition-all duration-300 shadow-xl transform hover:-translate-y-1">
