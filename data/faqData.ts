...
export const faqData: FaqItem[] = [
    ...
    {
        category: 'Förderung',
        question: 'Welche Förderungen gibt es für Agri-PV-Flächen?',
        answer:
            'Agri-PV profitiert von **EEG-Boni für besondere Solaranlagen**, regionalen Landwirtschaftsprogrammen und KfW-Förderkrediten. Wir kombinieren Ernteverträglichkeit mit Flächennutzungskonzepten und begleiten Genehmigungen.',
    },
    {
        category: 'Förderung',
        question: 'Welche Förderprogramme stehen 2025 für Unternehmen in Berlin zur Verfügung?',
