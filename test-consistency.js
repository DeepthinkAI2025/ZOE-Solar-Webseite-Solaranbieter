...
const crossPlatformEntityConsistencyService_1 = require("./services/crossPlatformEntityConsistencyService");
async function testConsistency() {
    try {
        console.log('🚀 Starte Platform Consistency Test...');
        // Registriere Plattformen
        console.log('📝 Registriere Plattformen...');
        await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.registerPlatform('google', {});
        await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.registerPlatform('facebook', {});
        await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.registerPlatform('linkedin', {});
        console.log('✅ Plattformen registriert');
        // Erstelle Unified Entity
        console.log('🔗 Erstelle Unified Entity...');
        const unifiedEntity = await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.createUnifiedEntity('1');
        ...
        const napResult = await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.performNAPConsistencyCheck();
        ...
        const correlation = await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.calculateAuthorityCorrelation('1');
        ...
        const report = await crossPlatformEntityConsistencyService_1.crossPlatformEntityConsistencyService.getConsistencyReport();
