...
2. **Container ausführen:**
  ...
  - Falls der Endpoint nicht erreichbar ist oder keine Daten liefert, greift – sofern `SERVER_OPENROUTER_API_KEY` konfiguriert ist – automatisch ein OpenRouter-Fallback, das die Herstellerseite per LLM analysiert und Produkte extrahiert.
3. **Artefakte sichern:**
