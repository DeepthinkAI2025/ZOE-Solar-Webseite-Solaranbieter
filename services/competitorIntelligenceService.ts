...
class CompetitorIntelligenceService {
  ...
  private constructor() {
    ...
    this.scheduleCompetitorIntelligence();
  }
  ...
  private scheduleCompetitorIntelligence(): void {
  ...
  public getCompetitorData() {
    return {
      profiles: this.getCompetitorProfiles(),
      analyses: this.getAllCompetitorAnalyses(),
      gaps: this.getCompetitiveGaps(),
      market: this.getMarketIntelligence()
    };
  }
